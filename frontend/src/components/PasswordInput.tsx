  ...
  return (
    <div className="relative">
      <input
        ...
        className={`w-full px-4 py-2.5 pr-11 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-500 focus:border-brand-500 outline-none transition ${className}`}
      />
      <button
        type="button"
