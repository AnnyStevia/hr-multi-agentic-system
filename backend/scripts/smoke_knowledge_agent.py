"""Smoke: Knowledge Agent end-to-end (1 embed + 1 generate; no retries).
...
try:
    ...
    print("citation_ids:", [c.citation_id for c in answer.citations])
    print("document_ids:", [c.company_document_id for c in answer.citations])
    print(
        "page_ranges:",
    ...
    print("smoke_knowledge_agent_ok: True")
finally:
    db.close()
